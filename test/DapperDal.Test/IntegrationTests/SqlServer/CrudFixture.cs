...
namespace DapperDal.Test.IntegrationTests.SqlServer
{
    ...
    public class CrudFixture
    {
        ...
        [TestFixture]
        public class QueryMethodWithOtherConn : SqlServerBaseFixture
        {
            [Test]
            public void UsingNone_ReturnsEntitys()
            {
                ...
                IEnumerable<PersonEntity> list = personDal.Query("Default",
                    "select * from Person where CarId = 3");
            ...
            public void UsingNone_ReturnsModels()
            {
                ...
                IEnumerable<PersonModel> list = personDal.Query<PersonModel>("Default",
                    "select PersonName as Name, CarId from Person where CarId = 3");
        ...
        [TestFixture]
        public class ExecuteMethodWithOtherConn : SqlServerBaseFixture
        {
            [Test]
            public void UsingNone()
            {
                ...
                personDal.Execute("Default", "update Person set IsActive = 1 where CarId = 3");
            ...
            public void UsingParameter()
            {
                ...
                personDal.Execute("Default", "update Person set IsActive = 1 where CarId = @CarId", new { CarId = 3 });
            ...
            public void UsingParameter_WithProcedure()
            {
                ...
                personDal.Execute("Default", "P_SetPersonsByCarId", new { CarId = 3 }, System.Data.CommandType.StoredProcedure);
            ...
            public void UsingDynamicParameter_WithProcedure_OutputCount()
            {
                ...
                personDal.Execute("Default", "P_SetPersonsByCarId_OutputCount", parameters, System.Data.CommandType.StoredProcedure);
        ...
        [TestFixture]
        public class QueryMultipleMethodWithOtherConn : SqlServerBaseFixture
        {
            [Test]
            public void UsingNone_ReturnsMultiples()
            {
                ...
                var tuple = personDal.QueryMultiple<PersonEntity, PersonModel>("Default",
                    "select * from Person where CarId = 3;select PersonName AS [Name], CarId from Person where CarId = 3");
